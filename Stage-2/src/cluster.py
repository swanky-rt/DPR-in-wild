...
if __name__ == "__main__":
    ...
    # UMAP params (DPBench defaults: n_neighbors=5, min_dist=0.1, n_components=10)
    # For small datasets (<20 tables), lower n_neighbors
    ...
    # HDBSCAN params (DPBench defaults: min_cluster_size=5)
    # For small datasets, lower min_cluster_size
    ...
    parser.add_argument("--vectorizer_min_df", type=int, default=1)
